...
//   var apiKey = "https://api.apispreadsheets.com/data/DFEI29cpaGLq67Ze/";
...
const login = function () {
  fetch('https://api.apispreadsheets.com/data/DFEI29cpaGLq67Ze/') // 1) Fetch function returns a promise that resolves to a 'response' object //
    .then(res => {
    ...
    .then(data => {
      ...
      return fetch('https://api.apispreadsheets.com/data/DFEI29cpaGLq67Ze/');
    })
    .then(res => {
      console.log(res.status);
      return res.json();
